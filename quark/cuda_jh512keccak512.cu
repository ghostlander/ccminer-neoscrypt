...
__global__
void quark_jh512Keccak512_gpu_hash_64(int threads, uint32_t startNounce, uint32_t *g_hash, uint32_t *g_nonceVector)
{
...
__host__ void cuda_jh512Keccak512_cpu_hash_64(int thr_id, int threads, uint32_t startNounce, uint32_t *d_nonceVector, uint32_t *d_hash, int order)
{
	...
	quark_jh512Keccak512_gpu_hash_64 << <grid, block, shared_size >> >(threads, startNounce, d_hash, d_nonceVector);
